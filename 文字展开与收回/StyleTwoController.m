...
@interface StyleTwoController ()<UITableViewDataSource,UITableViewDelegate,reloadTwoDelegate>
...
- (void)viewDidLoad {
    ...
    NSString *str = @"有一天，大哥悄悄地对我说：“你过来，我给你做了个顶顶好看的蝴蝶结。”大哥手巧，我知道的，便跟他到了家门口。大哥从他的书包里小心地掏出一个蝴蝶结来。呀，那是我见过的最漂亮的蝴蝶结！它是用那时很稀罕的红的确良布的，还有黑线镶边饰纹缀斑，简直就是一只翩翩起舞的蝴蝶。我简直不敢相信它会属于我。“小妹人俊，系上这就更漂亮了。";
    for (NSInteger i = 0; i < 20; i++) {
        StyleTwoModel *model = [[StyleTwoModel alloc]init];
...
{
    StyleTwoModel *model = _dataArr[indexPath.row];
...
{
   StyleTwoCell *cell = [tableView dequeueReusableCellWithIdentifier:@"styletwocell" forIndexPath:indexPath];
    StyleTwoModel *model = _dataArr[indexPath.row];
    [cell setWithModelTwo:model indexPath:indexPath];
    cell.delegate = self;
    return cell;
}
